...
This example project demonstrates how to use BatConf to provide config
management for a python project. The implementation in project/conf.py, and uses
in example lib and cli modules should be considered standard-practice.
...
The example project is working python package, and can be a useful playground
for experimentation.
